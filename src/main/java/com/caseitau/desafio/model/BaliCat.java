...
public class BaliCat {
	...
	public class Weight {
		...
		public void setImperial(String imperial) {
			this.weight.imperial = imperial;
		}
		public String getMetric() {
			return weight.metric;
		}
		public void setMetric(String metric) {
			this.weight.imperial = metric;
		}
		public String getId() {
			return id;
		}
		...
		public String toString() {
			return "Siberian Cat informations: Imperial Weight=" + weight.imperial + ", Metric Weight=" + weight.metric + ", id=" + id + ", name=" + name
					+ ", cfa_url=" + cfa_url + ", vetstreet_url=" + vetstreet_url + ", vcahospitals_url="
					+ vcahospitals_url + ", temperament=" + temperament + ", origin=" + origin + ", country_codes="
					+ country_codes + ", country_code=" + country_code + ", description=" + description + ", life_span="
					+ life_span + ", indoor=" + indoor + ", alt_names=" + alt_names + ", adaptability=" + adaptability
					...
					+ vocalisation + ", experimental=" + experimental + ", hairless=" + hairless + ", natural="
					+ natural + ", rare=" + rare + ", rex=" + rex + ", suppressed_tail=" + suppressed_tail
					+ ", short_legs=" + short_legs + ", wikipedia_url=" + wikipedia_url + ", hypoallergenic="
					+ hypoallergenic + ", reference_image_id=" + reference_image_id + "]";
		}
